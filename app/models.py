...
class SmartControlUpdate(BaseModel):
    ...
    preset_sudah_f: float | None = Field(default=None, ge=50, le=90)
    preset_all_day_f: float | None = Field(default=None, ge=50, le=90)
    preset_sleeping_f: float | None = Field(default=None, ge=50, le=90)
    active_preset: Literal["sudah", "all_day", "sleeping"] | None = None
